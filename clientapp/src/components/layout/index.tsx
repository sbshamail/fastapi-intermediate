...
//admin component
import Dashboard from '../@cui/dashboard';
// action
...
//content
import { adminSidebarList } from '@/utils/contents/adminSidebarList';
interface Props {
  ...
  return (
    <div>
      {pathname?.startsWith('/admin') ? (
        <Dashboard user={user} isAuth={isAuth} data={adminSidebarList}>
          {children}
        </Dashboard>
      ) : (
